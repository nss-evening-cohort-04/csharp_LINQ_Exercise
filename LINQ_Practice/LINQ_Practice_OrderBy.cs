...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(p => p.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(p => p.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(p => p.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
