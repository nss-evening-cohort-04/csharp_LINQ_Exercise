...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(cohort => cohort.Students[0].Birthday.Date).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData.OrderByDescending(cohort => cohort.Students[0].Birthday.Date).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData.OrderBy(instructors => instructors.JuniorInstructors[2].LastName).ToList();
