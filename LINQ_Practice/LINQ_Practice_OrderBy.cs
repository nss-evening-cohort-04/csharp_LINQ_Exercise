...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(student => student.Birthday).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(student => student.Birthday).ToList(); 
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(juniorInstructor => juniorInstructor.LastName).ToList();
