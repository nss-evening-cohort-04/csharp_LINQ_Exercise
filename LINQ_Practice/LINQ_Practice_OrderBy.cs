...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(byName => byName.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(x =>x.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(x => x.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(x => x.LastName).ToList();
