...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(active => active.Active == true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(fulltime => fulltime.FullTime == true).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(jurnellIs => jurnellIs.PrimaryInstructor.FirstName == "Jurnell").ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(threeInst => threeInst.JuniorInstructors.Count == 3).ToList();
