...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(x => x.Active == true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(x => x.FullTime == true).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(x => x.PrimaryInstructor.FirstName == "Jurnell").ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(x => x.JuniorInstructors.Count == 3).ToList();
