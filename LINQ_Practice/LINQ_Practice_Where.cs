...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(p => p.Active == true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(p => p.FullTime == true).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(p => p.JuniorInstructors.Count == 3).ToList();
