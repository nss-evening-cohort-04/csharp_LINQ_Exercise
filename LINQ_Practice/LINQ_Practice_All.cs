...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(x => x.PrimaryInstructor.Birthday.Year.ToString().Substring(0,3) == "198" );
        ...
        {
            var doAll = PracticeData[0].Students.All(x=> x.FirstName.ToLower().Contains("e")); //Hint: Cohort1 would be PracticeData[0]
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(x => x.Active && x.PrimaryInstructor.FirstName.ToLower().Contains("e"));
