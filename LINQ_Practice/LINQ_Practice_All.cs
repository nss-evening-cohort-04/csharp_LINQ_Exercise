...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(x => x.JuniorInstructors.Capacity >= 2);
        ...
        {
            var doAll = PracticeData.All(x => x.Students.Capacity >= 5);
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(x => x.PrimaryInstructor.Birthday.Year <= 1980);
        ...
        {
            var doAll = PracticeData.All(firstA => firstA.PrimaryInstructor.FirstName =="A");
