...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData[0].Students.All(student => student.FirstName.ToLower().Contains("e") == true); //Hint: Cohort1 would be PracticeData[0]
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(cohort => cohort.PrimaryInstructor.FirstName.ToLower().Contains("a") == true);
