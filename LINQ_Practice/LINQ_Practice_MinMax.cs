...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(x => x.Birthday.Date); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(x => x.Birthday); //HINT: Cohort3 is PracticeData[2]
