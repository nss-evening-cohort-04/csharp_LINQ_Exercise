...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(p => p.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(p => p.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(p => p.JuniorInstructors.Count); 
