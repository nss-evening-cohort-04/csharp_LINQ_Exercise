...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(cohort => cohort.FullTime == true && cohort.PrimaryInstructor.Birthday > new DateTime(2017, 2, 7));
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(cohort => cohort.PrimaryInstructor.FirstName == "Zelda" || cohort.JuniorInstructors.Any(x => x.FirstName
             == "Zelda"));
        ...
        {
            var shouldThrowException = PracticeData.Single(cohort => cohort.Active == true && cohort.FullTime == false);
        }
