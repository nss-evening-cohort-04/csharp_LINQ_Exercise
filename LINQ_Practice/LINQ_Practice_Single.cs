...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(threeJun => threeJun.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.Single(birthFuture => birthFuture.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(nameZelda => nameZelda.PrimaryInstructor.FirstName =="Zelda");
        ...
        {
            var shouldThrowException = PracticeData.Single(activeNotFull => activeNotFull.Active == false && activeNotFull.FullTime == false);
        }
        ...
        {
            var shouldThrowException = PracticeData.SingleOrDefault(jun2 => jun2.JuniorInstructors.Count == 2);
        }
    }
}
