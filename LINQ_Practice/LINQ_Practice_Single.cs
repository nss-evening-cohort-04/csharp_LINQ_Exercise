...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(cohort => cohort.FullTime == true && cohort.PrimaryInstructor.Birthday > new DateTime (2017, 2, 13));
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(cohort => cohort.PrimaryInstructor.FirstName == "Zelda" || cohort.JuniorInstructors.Any(instructor => instructor.FirstName == "Zelda"));
