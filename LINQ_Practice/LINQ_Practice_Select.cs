...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(Instructor => Instructor.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(Student => Student.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(Instructor => Instructor.PrimaryInstructor.FirstName).ToList();
