...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(primInAll => primInAll.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(x => x.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(primInAll => primInAll.PrimaryInstructor.FirstName).ToList();
        ...
        {
            var expected = PracticeData.Select(coNames => coNames.Name).ToList();
