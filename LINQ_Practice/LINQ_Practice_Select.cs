...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(x => x.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.Select(x => x.PrimaryInstructor.FirstName).ToList();
        ...
        {
            var expected = PracticeData.Select(x => x.Name).ToList();
