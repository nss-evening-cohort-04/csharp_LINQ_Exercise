...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => cohort.PrimaryInstructor.FirstName == "Zachary" && cohort.PrimaryInstructor.LastName == "Zohan" || cohort.JuniorInstructors.Any(juniorInstructor => juniorInstructor.FirstName == "Zachary" && juniorInstructor.LastName == "Zohan")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => (cohort.FullTime == false) && (cohort.PrimaryInstructor.Active == true) && (cohort.JuniorInstructors.All(juniorInstructor => juniorInstructor.Active == true))).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => (cohort.Students.Any(student => student.FirstName == "Kate")) || cohort.PrimaryInstructor.FirstName == "Kate" || cohort.JuniorInstructors.Any(juniorInstructor => juniorInstructor.FirstName == "Kate")).ToList();
        ...
        {
            var student = PracticeData.SelectMany(cohort => cohort.Students).OrderBy(students => students.Birthday).Last();
