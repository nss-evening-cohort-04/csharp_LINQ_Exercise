...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => cohort.PrimaryInstructor.FirstName == "Zachary" && cohort.PrimaryInstructor.LastName == "Zohan" || cohort.JuniorInstructors.Any(jInstructor => jInstructor.FirstName == "Zachary" && jInstructor.LastName == "Zohan")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => (cohort.FullTime == false) && (cohort.PrimaryInstructor.Active == true) && (cohort.JuniorInstructors.All(jInstructor => jInstructor.Active == true))).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => (cohort.Students.Any(student => student.FirstName == "Kate")) ||  (cohort.PrimaryInstructor.FirstName == "Kate") || (cohort.JuniorInstructors.Any(jInstructor => jInstructor.FirstName == "Kate"))).ToList();
        ...
        {
            var student = PracticeData.SelectMany(cohort => cohort.Students).OrderByDescending(students => students.Birthday).Last();
