...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.PrimaryInstructor.FirstName == "Zachary" && c.PrimaryInstructor.LastName == "Zohan" || c.JuniorInstructors.Any(j => j.FirstName == "Zachary")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.Students.Any(s => s.FirstName == "Kate") || c.PrimaryInstructor.FirstName =="Kate" || c.JuniorInstructors.Any(j => j.FirstName == "Kate")).ToList();
