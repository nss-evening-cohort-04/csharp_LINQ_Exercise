...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(x => x.JuniorInstructors.Any(y => y.FirstName == "Zachary") || x.PrimaryInstructor.FirstName == "Zachary").ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(x => x.FullTime == false && x.PrimaryInstructor.Active == true && x.JuniorInstructors.All(y => y.Active == true)).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(x => x.JuniorInstructors.Any(y => y.FirstName == "Kate") || x.PrimaryInstructor.FirstName == "Kate" || x.Students.Any(y => y.FirstName == "Kate") ).ToList();
        ...
        {
            var student = PracticeData.SelectMany(x => x.Students).OrderBy(y => y.Birthday).First();
        ...
        {
            var student = PracticeData.SelectMany(x => x.Students).OrderBy(y => y.Birthday).Last();
        ...
        {
            var ActualStudents = PracticeData.SelectMany(x => x.Students).Where(y => y.Active == false).OrderBy(z => z.LastName).ToList();
