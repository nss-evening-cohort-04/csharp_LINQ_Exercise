...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(kateIsIns => kateIsIns.PrimaryInstructor.FirstName == "Kate");
        ...
        {
            var ActualCohort = PracticeData.First(jun3 => jun3.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.First(primAndFull => primAndFull.FullTime == true && primAndFull.PrimaryInstructor.Birthday.Year > DateTime.Now.Year);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(zname => zname.PrimaryInstructor.FirstName == "Zelda");
        ...
        {
            var shouldThrowException = PracticeData.First(actFull => actFull.Active == false && actFull.FullTime == false);
        }

        [TestMethod]
        public void GetFirstCohortWith2JuniorInstructors()
        {
            var ActualCohort = PracticeData.First(twoInstru => twoInstru.JuniorInstructors.Count == 2);
