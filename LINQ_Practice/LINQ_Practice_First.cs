...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(cohort => cohort.FullTime == true && cohort.PrimaryInstructor.Birthday > new DateTime(2017, 2, 11));
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(cohort => cohort.PrimaryInstructor.FirstName == "Zelda" || cohort.JuniorInstructors.Any(instructor => instructor.FirstName == "Zelda"));
